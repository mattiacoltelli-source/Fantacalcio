...
const UI = {
  ...
  playerCard(player) {
    ...
    if (sc && sc.matches > 0) {
      ...
      if (sc.xg != null) {
        ...
        currSection +=
          '<div class="card-stats-section-label card-stats-adv-label" style="color:#00d4aa55;">&#128200; Avanzati (in corso)</div>' +
          '<div class="card-stats">' +
            '<div class="stat stat-adv"><span class="stat-label">xG</span><span class="stat-val adv-val curr-val">' + (sc.xg||0).toFixed(1) + '</span></div>' +
            '<div class="stat stat-adv"><span class="stat-label">xA</span><span class="stat-val adv-val curr-val">' + (sc.xa||0).toFixed(1) + '</span></div>' +
            '<div class="stat stat-adv"><span class="stat-label">Gol/90</span><span class="stat-val adv-val curr-val">' + gol90curr + '</span></div>' +
          '</div>';
      }
    }
      ...
      '<div class="card-body">' +
        ...
        (sp.xg != null ? (
          ...
          '<div class="card-stats">' +
            ...
            '<div class="stat stat-adv"><span class="stat-label">Gol/90</span><span class="stat-val adv-val">' + (sp.goals_per90 != null ? sp.goals_per90.toFixed(2) : (sp.matches > 0 ? (sp.goals / sp.matches).toFixed(2) : '-')) + '</span></div>' +
  ...
  renderFocus() {
    ...
    if (sc && sc.matches > 0) {
      focusCurrSection =
        '<div class="card-stats-section-label card-stats-curr-label" style="margin-top:12px;">&#128293; Stagione in corso (' + sc.matches + ' pres.)</div>' +
        '<div class="focus-stats">' +
          '<div class="focus-stat"><span class="focus-stat-label">FV media</span><span class="focus-stat-val curr-val">' + (sc.fantavote||'-') + '</span></div>' +
          '<div class="focus-stat"><span class="focus-stat-label">Gol</span><span class="focus-stat-val curr-val">' + (sc.goals||0) + '</span></div>' +
          '<div class="focus-stat"><span class="focus-stat-label">Assist</span><span class="focus-stat-val curr-val">' + (sc.assists||0) + '</span></div>' +
        '</div>';
      if (sc.xg != null) {
        var gol90c = sc.goals_per90 != null ? sc.goals_per90.toFixed(2) : (sc.matches > 0 ? (sc.goals / sc.matches).toFixed(2) : '-');
        focusCurrSection +=
          '<div class="card-stats-section-label card-stats-adv-label" style="color:#00d4aa55;">&#128200; Avanzati (in corso)</div>' +
          '<div class="focus-stats">' +
            '<div class="focus-stat focus-stat-adv"><span class="focus-stat-label">xG</span><span class="focus-stat-val adv-focus-val curr-val">' + (sc.xg||0).toFixed(1) + '</span></div>' +
            '<div class="focus-stat focus-stat-adv"><span class="focus-stat-label">xA</span><span class="focus-stat-val adv-focus-val curr-val">' + (sc.xa||0).toFixed(1) + '</span></div>' +
            '<div class="focus-stat focus-stat-adv"><span class="focus-stat-label">Gol/90</span><span class="focus-stat-val adv-focus-val curr-val">' + gol90c + '</span></div>' +
          '</div>';
      }
    }
    ...
    overlay.innerHTML =
      ...
      '<div class="focus-panel">' +
        ...
        '<div class="focus-body">' +
          ...
          '</div>' +
          '<div class="card-stats-section-label" style="padding:8px 0 4px;">&#128197; Stagione precedente</div>' +
          '<div class="focus-stats">' +
          ...
          (sp.xg != null ? (
            ...
            '<div class="focus-stats">' +
              ...
              '<div class="focus-stat focus-stat-adv"><span class="focus-stat-label">Gol/90</span><span class="focus-stat-val adv-focus-val">' + (sp.goals_per90 != null ? sp.goals_per90.toFixed(2) : (sp.matches > 0 ? (sp.goals / sp.matches).toFixed(2) : '-')) + '</span></div>' +
    ...
    return (
      '<div class="wl-filters-bar">' +
        ...
        '<div class="wl-filters-row">' +
          '<select class="filter-select" onchange="WLFilters.role=this.value; UI.renderWatchlist();">' +
            '<option value="ALL"' + (WLFilters.role==='ALL'?' selected':'') + '>Tutti i ruoli</option>' +
            '<option value="POR"' + (WLFilters.role==='POR'?' selected':'') + '>Portieri</option>' +
            '<option value="DIF"' + (WLFilters.role==='DIF'?' selected':'') + '>Difensori</option>' +
            '<option value="CEN"' + (WLFilters.role==='CEN'?' selected':'') + '>Centrocampisti</option>' +
            '<option value="ATT"' + (WLFilters.role==='ATT'?' selected':'') + '>Attaccanti</option>' +
          '</select>' +
