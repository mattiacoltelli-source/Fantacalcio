      ...
      '<div class="card-body">' +
        ...
        (sp.xg != null ? (
          ...
          '<div class="card-stats">' +
            ...
            '<div class="stat stat-adv"><span class="stat-label">Tiri/90 min</span><span class="stat-val adv-val">' + (sp.shots_per90||0).toFixed(1) + '</span></div>' +
          '</div>'
        ) : '') +
        currSection +
      '</div>' +
        ...
        '<div class="focus-body">' +
          ...
          (sp.xg != null ? (
            ...
            '<div class="focus-stats">' +
              ...
              '<div class="focus-stat focus-stat-adv"><span class="focus-stat-label">Tiri/90 min</span><span class="focus-stat-val adv-focus-val">' + (sp.shots_per90||0).toFixed(1) + '</span></div>' +
            '</div>'
          ) : '') +
